...
pub fn  setup_emarsys_sources_tables() ->  HashMap<&'static str, String>{
    ...
    let sql_filter = format!("where date(loaded_at, \"Asia/Singapore\") = \"{}\"",execution_date);

    
    let result:  HashMap<&str, String> = [
        ("emarsys_normalized_reg_form_view", format!("{}.editable_dataset.normalized_reg_form_view", emarsys_google_project)),
        ("emarsys_prof_forms", format!("{}.editable_dataset.prof_forms", emarsys_google_project)),
        ("emarsys_suite_contact_0", format!("{}.editable_dataset.suite_contact_0", emarsys_google_project)),
        ("emarsys_email_bounces", format!("{}.{}.email_bounces_794867401 {}", emarsys_google_project, src_dataset, sql_filter)),
        ("emarsys_email_campaign_categories", format!("{}.{}.email_campaign_categories_794867401", emarsys_google_project, src_dataset)),
        ("emarsys_email_campaigns", format!("{}.{}.email_campaigns_794867401 {}", emarsys_google_project, src_dataset, sql_filter)),
        ("emarsys_email_campaigns_v2", format!("{}.{}.email_campaigns_v2_794867401 {}", emarsys_google_project, src_dataset, sql_filter)),
        ("emarsys_email_cancels", format!("{}.{}.email_cancels_794867401 {}", emarsys_google_project, src_dataset, sql_filter)),
        ("emarsys_email_clicks", format!("{}.{}.email_clicks_794867401 {}", emarsys_google_project, src_dataset, sql_filter)),
        ("emarsys_email_complaints", format!("{}.{}.email_complaints_794867401 {}", emarsys_google_project, src_dataset, sql_filter)),
        ("emarsys_email_opens", format!("{}.{}.email_opens_794867401 {}", emarsys_google_project, src_dataset, sql_filter)),
        ("emarsys_email_sends", format!("{}.{}.email_sends_794867401 {}", emarsys_google_project, src_dataset, sql_filter)),
        ("emarsys_email_unsubscribes", format!("{}.{}.email_unsubscribes_794867401 {}", emarsys_google_project, src_dataset, sql_filter)),
        ("emarsys_session_categories", format!("{}.{}.session_categories_794867401 {}", emarsys_google_project, src_dataset, sql_filter)),
        ("emarsys_session_purchases", format!("{}.{}.session_purchases_794867401 {}", emarsys_google_project, src_dataset, sql_filter)),
        ("emarsys_session_views", format!("{}.{}.session_views_794867401 {}", emarsys_google_project, src_dataset, sql_filter)),
        ("emarsys_sessions", format!("{}.{}.sessions_794867401 {}", emarsys_google_project, src_dataset, sql_filter)),
    ].iter()
    .cloned()
    .collect();
